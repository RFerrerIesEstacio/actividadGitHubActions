 ...
 * Summary exports
 */
var summary_1 = __nccwpck_require__(8645);
Object.defineProperty(exports, "summary", ({ enumerable: true, get: function () { return summary_1.summary; } }));
/**
 * @deprecated use core.summary
 */
var summary_2 = __nccwpck_require__(8645);
Object.defineProperty(exports, "markdownSummary", ({ enumerable: true, get: function () { return summary_2.markdownSummary; } }));
/**
 * Path exports
 */
var path_utils_1 = __nccwpck_require__(2499);
...
const os = __importStar(__nccwpck_require__(2037));
const uuid_1 = __nccwpck_require__(2531);
const utils_1 = __nccwpck_require__(6173);
...
const http_client_1 = __nccwpck_require__(8666);
const auth_1 = __nccwpck_require__(9633);
...
const pm = __importStar(__nccwpck_require__(9638));
const tunnel = __importStar(__nccwpck_require__(2177));
var HttpCodes;
(function (HttpCodes) {
...
var parse = __nccwpck_require__(4536);
var enoent = __nccwpck_require__(453);
...
function spawnSync(command, args, options) {
    ...
    if (!cpSpawnSync) {
        try {
            cpSpawnSync = __nccwpck_require__(6821);  // eslint-disable-line global-require
        } catch (ex) {
            throw new Error(
...
var resolveCommand = __nccwpck_require__(6141);
...
var LRU = __nccwpck_require__(2088);
var resolveCommand = __nccwpck_require__(6141);
var hasBrokenSpawn = __nccwpck_require__(8275);
...
var which = __nccwpck_require__(1766);
var LRU = __nccwpck_require__(2088);
...
module.exports = __nccwpck_require__(1833)(exports);
...
function setup(env) {
  ...
  createDebug.humanize = __nccwpck_require__(97);
...
if (typeof process === 'undefined' || process.type === 'renderer' || process.browser === true || process.__nwjs) {
  module.exports = __nccwpck_require__(6160);
} else {
...
try {
  ...
  var supportsColor = __nccwpck_require__(9986);
...
__nccwpck_require__(5950)(gm.prototype);
__nccwpck_require__(1889)(gm);
__nccwpck_require__(1625)(gm.prototype);
__nccwpck_require__(6456)(gm.prototype);
__nccwpck_require__(1614)(gm.prototype);
__nccwpck_require__(8191)(gm.prototype);
__nccwpck_require__(647)(gm.prototype);
__nccwpck_require__(2538)(gm.prototype);
__nccwpck_require__(9165)(gm.prototype);
...
module.exports.utils = __nccwpck_require__(4134);
module.exports.compare = __nccwpck_require__(647)();
...
var argsToArray = (__nccwpck_require__(4134).argsToArray);
var isUtil = (__nccwpck_require__(4134).isUtil);
/**
 * Extend proto
 */
...
var spawn = __nccwpck_require__(4630);
var utils = __nccwpck_require__(4134);
var debug = __nccwpck_require__(1292)('gm');
var series = __nccwpck_require__(8320);
...
module.exports = function (proto) {
  __nccwpck_require__(5745)(proto);
  __nccwpck_require__(6593)(proto);
  __nccwpck_require__(4353)(proto);
  __nccwpck_require__(2452)(proto);
}
...
var fs = __nccwpck_require__(7147);
var parallel = __nccwpck_require__(385);
...
var escape = (__nccwpck_require__(4134).escape);
...
if (process.platform === 'win32' || global.TESTING_WINDOWS) {
  core = __nccwpck_require__(1245)
} else {
  core = __nccwpck_require__(3832)
}
...
var Map = __nccwpck_require__(1356)
var util = __nccwpck_require__(3837)

// A linked list to keep track of recently-used-ness
var Yallist = __nccwpck_require__(6728)
...
let gm = __nccwpck_require__(8588)
...
if (typeof Map === 'function' && !process.env.TEST_PSEUDOMAP) {
  ...
  module.exports = __nccwpck_require__(3538)
}
...
var _v = _interopRequireDefault(__nccwpck_require__(2892));

var _v2 = _interopRequireDefault(__nccwpck_require__(3102));

var _v3 = _interopRequireDefault(__nccwpck_require__(5596));

var _v4 = _interopRequireDefault(__nccwpck_require__(9432));

var _nil = _interopRequireDefault(__nccwpck_require__(9669));

var _version = _interopRequireDefault(__nccwpck_require__(2690));

var _validate = _interopRequireDefault(__nccwpck_require__(3275));

var _stringify = _interopRequireDefault(__nccwpck_require__(9564));

var _parse = _interopRequireDefault(__nccwpck_require__(8820));
...
var _rng = _interopRequireDefault(__nccwpck_require__(9242));
...
var _v = _interopRequireDefault(__nccwpck_require__(6385));

var _md = _interopRequireDefault(__nccwpck_require__(8139));
...
var _sha = _interopRequireDefault(__nccwpck_require__(5172));
...
var _regex = _interopRequireDefault(__nccwpck_require__(9171));
...
var path = __nccwpck_require__(1017)
var COLON = isWindows ? ';' : ':'
var isexe = __nccwpck_require__(5142)
...
memeMaker(options, function(err) {
  ...
  fs.appendFileSync('README.md', `![alt text](https://github.com/RFerrerIesEstacio/actividadGitHubActions/blob/readme-job/.github/actions/change-readme/outputImg/${outPutName}?raw=true)\n`);
